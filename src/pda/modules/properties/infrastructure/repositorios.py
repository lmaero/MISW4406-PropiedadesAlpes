...
from .mapeadores import MapperReserva
...
class SQLiteTransactionsRepository(TransactionsRepository):
    ...
    def get_by_id(self, entity_id: UUID) -> Transaction:
        ...
        return self.properties_factory.create_object(transaction_dto, MapperReserva())
    ...
    def add(self, transaction: Transaction):
        transaction_dto = self.properties_factory.create_object(
            transaction, MapperReserva()
        )
        db.session.add(transaction_dto)
        db.session.commit()

    def update(self, reserva: Transaction):
        # TODO
        raise NotImplementedError

    def delete(self, reserva_id: UUID):
        # TODO
        raise NotImplementedError
